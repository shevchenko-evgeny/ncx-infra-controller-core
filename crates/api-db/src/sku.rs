...
pub async fn create(txn: &mut PgConnection, sku: &Sku) -> Result<(), DatabaseError> {
    ...
    let query = "INSERT INTO machine_skus (id, description, components, schema_version, device_type) values ($1, $2, $3, $4, $5)";
...
pub async fn replace(txn: &mut PgConnection, sku: &Sku) -> Result<Sku, DatabaseError> {
    ...
    let query = "UPDATE machine_skus set description=$1, components=$2, schema_version=$3, device_type=$4 WHERE id=$5";
